            ...
            while (true) {
                if (System.currentTimeMillis() - lastTime > 16) {
                    ...
                    if (ultimateClick) {
                        ...
                        } else if (!character.getClassCharacter().equals(ClassCharacters.BOB) && !character.getClassCharacter().equals(ClassCharacters.ELBOMBAS) && !character.getClassCharacter().equals(ClassCharacters.MONK)) {
