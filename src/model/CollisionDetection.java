...
public class CollisionDetection {
    ...
    public static PlayerCollisionSide isCollisionBetween(Object object1, Object object2) {
        ...
        if (solidObject1 != null && solidObject2 != null) {
            ...
            Rectangle2D lineTopPlatform = new Rectangle2D.Float(solidObject2.getRelativeX()+(0.000000001f+PlayableCharacter.getRelativeMaxSpeed()), solidObject2.getRelativeY(), Platform.getRelativeWidth()-2*(0.000000001f+PlayableCharacter.getRelativeMaxSpeed()), 0.000000001f);
            Rectangle2D lineBottomPlatform = new Rectangle2D.Float(solidObject2.getRelativeX()+(0.000000001f+PlayableCharacter.getRelativeMaxSpeed()), solidObject2.getRelativeY()+Platform.getRelativeHeight(), Platform.getRelativeWidth()-2*(0.000000001f+PlayableCharacter.getRelativeMaxSpeed()), 0.000000001f);
            Rectangle2D lineRightPlatform = new Rectangle2D.Float(solidObject2.getRelativeX() + Platform.getRelativeWidth(), solidObject2.getRelativeY()+(0.000000001f+Terrain.getRelativeMaxGravity()),0.000000001f, Platform.getRelativeHeight()-2*(0.000000001f+Terrain.getRelativeMaxGravity()));
            Rectangle2D lineLeftPlatform = new Rectangle2D.Float((solidObject2.getRelativeX()), solidObject2.getRelativeY()+(0.000000001f+Terrain.getRelativeMaxGravity()), 0.000000001f, Platform.getRelativeHeight()-2*(0.000000001f+Terrain.getRelativeMaxGravity()));
